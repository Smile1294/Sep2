...
public class CandleStickChart extends XYChart<String, Number> {
    ...
    public CandleStickChart(String title, CategoryAxis xAxis, NumberAxis yAxis, List<BarData> bars, int maxBarsToDisplay) {
        ...
        setTitle(title);
        setAnimated(true);
//        System.out.println(getClass().getResource("/view/styles/CandleStickChartStyles.css"));
        getStylesheets().add(getClass().getResource("/view/styles/CandleStickChartStyles.css").toExternalForm());
