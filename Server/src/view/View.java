...
public enum View {
    PlaceOrder("PlaceOrder.fxml"),LOGIN("LoginView.fxml"),REGISTER("RegisterView.fxml"),ACCOUNT("AccountView.fxml"),CompanyList("CompanyListView.fxml"),CompanyView("CompanyView.fxml");
